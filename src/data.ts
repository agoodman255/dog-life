...
export const dogs: Dog[] = [
  ...
  },
  {
    ...
    allergies: [],
    medicationEntries: [
      { id: "griz-med-gabapentin", name: "Gabapentin (white oblong)", kind: "medication", dosage: "1 whole pill", frequency: "2x/day with meals", notes: "" },
      { id: "griz-med-carprofen", name: "Carprofen (brown circle)", kind: "medication", dosage: "Half pill", frequency: "2x/day with meals", notes: "" },
      { id: "griz-med-preventive", name: "Flea/tick + heartworm prevention", kind: "preventive", dosage: "1 dose", frequency: "Monthly", notes: "" },
      { id: "griz-med-salmon-oil", name: "Salmon oil", kind: "supplement", dosage: "Per label", frequency: "Daily with breakfast", notes: "" },
      { id: "griz-med-dasuquin", name: "Dasuquin", kind: "supplement", dosage: "Per label", frequency: "Daily with breakfast", notes: "Joint support" },
      { id: "griz-med-fortiflora", name: "FortiFlora probiotic", kind: "supplement", dosage: "1 packet", frequency: "Daily with dinner", notes: "" },
    ],
    energy: 66,
    confidence: 78,
    fearfulness: 18,
