...
**Still open:**
- **Neither migration has been run against production.** `migrate-quick-logs-2026-07-26.sql` (amended in place so it now produces the relaxed constraint) and `migrate-log-item-link-2026-07-27.sql`. All verification was done in offline mode on port 5174. Run both before using any of this against the real database.
